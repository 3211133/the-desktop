...
def test_widget_uses_real_when_env_not_set(qtbot, monkeypatch):
    ...
    monkeypatch.delenv("QUICKMEMO_DEV_MOCKS", raising=False)
    from quickmemo.features import weather as wm
